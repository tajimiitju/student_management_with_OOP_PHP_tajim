                ...
                <div class="panel panel-default">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            foreach ($students as $student) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a class="text-info" href="view/admin/student/view.php?id=<?php echo $student['unique_id']?>">View</a> |
                                        <a class="text-primary" href="view/admin/student/edit.php?id=<?php echo $student['unique_id']?>">Edit</a> |
                    ...
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="view/admin/student/tmp_delete.php" method="get">
